...
public class RobotConstants {
	...
	//Winch System Constants
	public static final int winchLeftMotorPort = 2;
	public static final int winchRightMotorPort = 3;
	...
	//PowerOutputHelper Constants
	public static final double winchLeftMotorPower = 0.5;
	public static final double winchRightMotorPower = 0.5;
}
