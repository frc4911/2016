...
//			}
			 ...
			 */
			//TODO: add back in
			//Robot.taskManager.addShooterTask(new SpinToPower(RobotMap.ShooterLiftMotor,ControllerMappings.payloadJoy.getRawAxis(1)));
			//			if(Math.abs(RobotMap.ShooterLiftTalon.get())<0.1){
